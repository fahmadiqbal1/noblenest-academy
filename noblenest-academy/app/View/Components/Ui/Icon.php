...
class Icon extends Component
{
    ...
    public static array $registry = [
        ...
        // Phase 1 — extended set covering legacy `bi bi-*` icons.
        // Generated via `node scripts/build-icon-registry.mjs` against
        // lucide@0.511.0. Names follow current Lucide canonical names; see
        // docs/phase1-launch/icon-migration.md for the bi-* mapping.
