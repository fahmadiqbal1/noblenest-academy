            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm shadow border-0">
                <div class="p-5">
                    <div class="text-center mb-4">
                        ...
                        <h2 class="font-bold mt-2">Welcome to Noble Nest Academy!</h2>
                        <p class="text-[var(--color-text-muted)]">Let's personalise your experience in 30 seconds.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('onboarding.store') }}">
                        ...
                        {{-- Step 1: Language --}}
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-1 font-semibold">Preferred Language</label>
                        ...
                        <div class="flex flex-wrap gap-3 mb-4">
                            <div class="md:w-6/12">
                                <label class="block text-sm font-medium text-gray-700 mb-1 font-semibold">Child's Name <span class="text-[var(--color-text-muted)] text-sm">(optional)</span></label>
                            ...
                            <div class="md:w-6/12">
                                <label class="block text-sm font-medium text-gray-700 mb-1 font-semibold">Child's Age</label>
                        ...
                        {{-- Step 4: Goals --}}
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-1 font-semibold">Learning Goals</label>
                            <div class="flex flex-wrap gap-2">
                                @php
                                    $goals = [
                        ...
                        <div class="grid gap-2">
                            <button type="submit" class="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 disabled:opacity-50 disabled:cursor-not-allowed bg-violet-600 text-white hover:bg-violet-700 px-5 py-3 text-lg">
                                <x-ui.icon name="rocket" /> Let's Start Learning!
                            </button>
                            <a href="{{ route('home') }}" class="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 disabled:opacity-50 disabled:cursor-not-allowed bg-transparent text-violet-600 hover:underline shadow-none text-[var(--color-text-muted)]">Skip for now</a>
                        </div>
                    </form>
                </div>
            </div>
