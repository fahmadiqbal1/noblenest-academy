    ...
    <div class="container mx-auto px-4">
        <nav class="flex items-center h-16 gap-4" aria-label="Main navigation">
            ...
            <ul class="hidden lg:flex items-center gap-1 ml-6 flex-1" role="list">
                ...
                <li>
                    <a href="{{ route('marketplace.index') }}" class="px-3 py-2 rounded-[var(--radius-sm)] text-sm font-bold text-[var(--color-text-muted)] hover:bg-[var(--color-primary-soft)] hover:text-[var(--color-primary)] transition-colors">
                        Marketplace
                    </a>
                </li>
            </ul>
