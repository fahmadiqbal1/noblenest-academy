...
@section('title', 'Add Child — Noble Nest Academy')

@section('content')
<div class="max-w-xl mx-auto">

    <x-ui.page-header
        title="{{ I18n::get('add_child') }}"
        subtitle="Create a new learning profile for your child"
    />
    ...
    <x-ui.card variant="clay" padding="lg">
        <form method="POST" action="{{ route('children.store') }}" novalidate>
            @csrf
                    ...
                    <div class="flex gap-6">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input
                                ...
                                name="is_muslim"
                                value="1"
                                @if(old('is_muslim') === '1') checked @endif
                        ...
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input
                                ...
                                name="is_muslim"
                                value="0"
                                @if(old('is_muslim', '0') === '0') checked @endif
                                class="w-4 h-4 accent-[var(--color-brand-600)] cursor-pointer"
                            >
